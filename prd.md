...
### Product Overview
Nano-Floor Designer is a WordPress plugin that enables users to visualize flooring options in their own spaces using AI-powered image generation. Visitors upload photos of their rooms and instantly preview new flooring materials rendered by Google's Gemini 3.1 Flash Image Preview model.
...
- **AI Processing**: Server-side integration with Google's Gemini 3.1 Flash Image Preview model, including fallback to the text+image endpoint.
...
- **External Services**: Google Gemini 3.1 Flash Image Preview API
